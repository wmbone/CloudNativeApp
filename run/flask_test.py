...
class FlaskappTests(unittest.TestCase):
    ...
    def test_addusers_status_code(self):
        ...
        result = self.app.post('/api/v1/users', data='{"username":"manish22", "email":"manishtest22@gmail.com", '
    ...
    def test_addtweets_status_code(self):
        # send HTTP GET request to the application on the specified path
        result = self.app.post('/api/v2/tweets', data='{"username":"mahesh@rocks","body":"Test"}', content_type='appllication/json')

    def test_delusers_status_code(self):
        # sends HTTP Delete request to the application
        result = self.app.delete('/api/v1/users', data='{username":"manish22"}', content_type='application/json')
        # assert the status code of the response
        self.assertEquals(result.status_code, 200)
